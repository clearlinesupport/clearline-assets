							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'About',
										'page_location': 'https://clearlinesupport.com/#about',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Services',
										'page_location': 'https://clearlinesupport.com/#services',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://clearlinesupport.com/#resources',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Contact',
										'page_location': 'https://clearlinesupport.com/#contact',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://clearlinesupport.com',
									});
								},
							],
						},
